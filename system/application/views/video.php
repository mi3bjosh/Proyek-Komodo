...
$(function(){
    ...
    // mengatur hasil pencarian dari video search
...
<li></li>
<li><a href="<?php echo base_url()."index.php/elearning/ebook"; ?>"><img src="<?php echo base_url(); ?>images/icoSet2/info.png" alt="Ebook" /></a></li>
<li><a href="<?php echo base_url()."index.php/elearning/chart"; ?>"><img src="<?php echo base_url(); ?>images/icoSet2/stats.png" alt="Stats" /></a></li></ul>
</div>
