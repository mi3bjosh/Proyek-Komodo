...
<div id="templatemo_wrapper">	
    ...
    <div id="templatemo_content">
        ...
        <div id="isian">
          ...
          <p>Pada Halaman Dosen disediakan fasilitas sebagai berikut :</p>
          <p>1. Modul Materi</p>
          <ul>
            <li>Dosen bisa menambahkan Materi Perkuliahan yang akan ditampilkan di halaman mahasiswa.</li>
            <li>Materi yang ditampilkan akan disimpan secara berkala dan akan diberikan latihan soal.</li>
          </ul>
          <p>	2. Modul Soal</p>
          <ul>
            <li>Dosen bisa menambahkan soal di halaman mahasiswa yang akan digunakan untuk mereview pemahaman mahasiswa terhadap materi yang diberikan.</li>
            <li>Hak akses manajemen latihan soal dipegang oleh user.</li>
          </ul>
          <p>3. Event Calender</p>
          <ul>
            <li>Dosen bisa membuat jadwal kegiatan di kolom Event Calendar.</li>
            <li>Dosen bisa menginformasikan kepada dosen lain mengenai kegiatan mata kuliah yang akan dilaksanakan.</li>
          </ul>	
          </div>
          <div class="box">
