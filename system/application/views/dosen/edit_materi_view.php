...
<div id="templatemo_wrapper">	
    ...
    <div id="templatemo_content">
        ...
        <div id="isian">
		 ...
		 <?php echo form_open('elearning/edit_materi/'.$kode);?>
	<?php echo anchor('/elearning/awal_materi','Kembali');?>
	<br/>
	<?php echo form_fieldset('Edit'); ?>
	<?php foreach($query as $row) {?>
	<table width="329" border="0">
  <tr>
    <td width="95">Kode Materi</td>
    <td width="21">:</td>
    <td width="199"><input type="text" id="kodeMateri" name="kodeMateri" value="<?php echo $row['kodeMateri']; ?>"/>
	<?php echo form_error('kodeMateri'); ?></td>
  </tr>
  <tr>
    <td>Nama Materi</td>
    <td>:</td>
    <td><input type ="text" id="namaMateri" name="namaMateri" value="<?php echo $row['namaMateri']; ?>"/>
	<?php echo form_error('namaMateri'); ?></td>
  </tr>
  <tr>
    <td></td>
    <td></td>
