...
<p>List Event :</p>
  ...
  // print_r ($dayevents);
  	...
  	foreach ($query as $query):
		...
		echo "<br />";
		echo $query->eventDate;
  		echo "<br />";
		echo "<br />";
  		echo "<h3>Judul Event : </h3>";
		echo "<br />";
		echo $query->eventTitle;
  		echo "<br />";
		echo "<br />";
  		echo "<h3>Keterangan Event : </h3>";
		echo "<br />";
		echo $query->eventContent;
		echo "<br />";
		echo "<br />";
		echo "</div>";
		echo anchor('dosen/calendar/edit/'.$query->id, 'Edit');
		echo " | ";
		echo anchor("dosen/calendar/delete/".$query->id,'Hapus');
