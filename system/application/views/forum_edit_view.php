...
<div id="templatemo_wrapper">	
	...
	#shout{
		...
		<div id="shout">
		<h1>Edit Forum</h1>
<?php foreach($forumku->result() as $value):  ?>
<?php echo form_open_multipart('elearning/forum_edit/'.$value->id); ?>




    What to Shout?: <br />
   <textarea name="shout" rows="5" cols="10"><?php echo $value->shout; ?></textarea><br>
