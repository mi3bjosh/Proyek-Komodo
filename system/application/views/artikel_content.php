	...
	<div id="top" class="clearfloat">
		...
		<div id="featured">
    		<h3>Tutorial Terbaru</h3>
                ...
                <tr>
                	<td>&bull; </td>
                	<td><font size=2><?php echo anchor('cartikel/view/'.$row->id, $row->judul); ?>
    			</font>
                	</td>
                </tr>
                	<?php endforeach; ?>
...
<ul id="navDemo02">
<li class="navActive"><a href="categorie/01.html"><img src="<?php echo base_url(); ?>images/icoSet2/home.png" alt="Home" /></a></li>
<li><a href="categorie/02.html"><img src="<?php echo base_url(); ?>images/icoSet2/chat.png" alt="Chat" /></a></li>
<li><a href="categorie/03.html"><img src="<?php echo base_url(); ?>images/icoSet2/upload.png" alt="Upload" /></a></li>
<li></li>
<li><a href="categorie/05.html"><img src="<?php echo base_url(); ?>images/icoSet2/info.png" alt="Info" /></a></li>
<li><a href="categorie/06.html"><img src="<?php echo base_url(); ?>images/icoSet2/stats.png" alt="Stats" /></a></li>
<li></li>
</ul>
</div>
