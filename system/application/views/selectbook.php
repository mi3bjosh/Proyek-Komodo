...
<table border="0" align="center">
            <?php foreach ($n_ebook as $row){ ?>
            <tr>
            <td width="154" rowspan="3">
            <img src='<?php echo base_url().'/img/'.$row->photo; ?>' width="150"/> 
            </td>
            <td width="80%">
            ...
            <tr> 
            <td>
            <?php echo anchor('EbookController/validatorShowEbookOnline/'.$row->idebook.'', '> Read PDF'); ?>
            </td>
            </tr>
