...
<div id="templatemo_wrapper">	
    ...
    <div id="templatemo_content">
        ...
        FusionCharts. </div>
		   ...
		   var chart = new FusionCharts("<?=base_url(); ?>/Chart/FCF_Pie3D.swf", "ChartId", "600", "350");
		   chart.setDataURL("<?=base_url(); ?>Data/Pie3D.xml");		   
		   chart.render("chartdiv1");
		</script>
          <div id="chartdiv" align="center"> 
        FusionCharts. </div>
      <script type="text/javascript">
		   var chart = new FusionCharts("<?php echo base_url(); ?>/Chart/FCF_Column3D.swf", "ChartId", "600", "350");
