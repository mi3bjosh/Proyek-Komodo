...
<div id="templatemo_wrapper">	
    ...
    <div id="templatemo_banner">
		...
		<li >
            ...
            <div class="button_01"><a href="artikel">Read More</a></div>
...
<table width="475" border="0" cellpadding="0" cellspacing="0" align="center">
  <!--DWLayoutTable-->
  <tr>
    <td width="290" height="20" valign="top"><span class="jdldonlot"><b><?php echo $p->JudulPW; ?></b></span></td>
    <td width="12">&nbsp;</td>
    <td width="108" rowspan="3" align="center" valign="middle"><b>Download</b>
      <span class="con"><?php echo $p->counter; ?></span></td>
    <td width="65" rowspan="3" align="center" valign="middle">
	<a href="<?php echo base_url().index_page(); ?>/project/donlot/<?php echo $p->IdPW.'/'.$p->counter; ?>" title="download this project">
		<img src="<?php echo base_url(); ?>images/download.png" width="45" height="45">	</a></td>
  </tr>
  <tr>
    <td height="20" valign="top"><p align="justify"><?php echo $p->Deskripsi; ?></p></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="20" colspan="4" align="right" valign="middle" class="postby"><hr/></td>
    </tr>
</table>
<?php
//echo br(1); 
