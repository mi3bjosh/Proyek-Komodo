...
<br>
<?php 
echo anchor("admin/arsipmateri","View All Data")." | ".anchor("admin/arsipmateri/tampilMk","Pilih Mata Kuliah")." | ".anchor("admin/arsipmateri/tampilKategori","Pilih Kategori")." | ".anchor("admin/arsipmateri/tambah_back","Tambah Data")." | ".anchor("admin/arsipmateri/tampildata","Muat Ulang")." | ".anchor("admin/arsipmateri/trash","Tempat Sampah")."<br>";
} ?>