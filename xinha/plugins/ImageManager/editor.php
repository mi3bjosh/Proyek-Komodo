...
<div id="tools">
	<div id="tools_crop" style="display:none;">
		<div id="tool_inputs">
			...
			<label for="cw">Larghezza:</label><input type="text" id="cw" class="textInput" onchange="updateMarker('crop')"/>
			<label for="ch">Altezza:</label><input type="text" id="ch" class="textInput" onchange="updateMarker('crop')"/>
	...
	<div id="tools_scale" style="display:none;">
		<div id="tool_inputs">
			<label for="sw">Larghezza:</label><input type="text" id="sw" class="textInput" onchange="checkConstrains('width')"/>
			...
			<label for="constProp">Mantieni proporzioni</label>
			<img src="<?php print $IMConfig['base_url'];?>img/div.gif" height="30" width="2" class="div" alt="|" />
		</div>	
	...
	<div id="tools_rotate" style="display:none;">
		<div id="tool_inputs">
			...
			<select name="rotate" onchange="rotatePreset(this)" style="margin-left: 20px; vertical-align: middle;">
              <option selected>Ruota Immagine</option>
              <option>-----------------</option>

              <option value="180">Ruota 180 &deg;</option>
              <option value="90">Ruota 90 &deg; CW</option>
              <option value="-90">Ruota 90 &deg; CCW</option>
         </select>
			<label for="ra">Angolo:</label><input type="text" id="ra" class="textInput" />
			<img src="<?php print $IMConfig['base_url'];?>img/div.gif" height="30" width="2" class="div" alt="|" />
		</div>	
	...
	<div id="tools_save" style="display:none;">
		<div id="tool_inputs">
			<label for="save_filename">Nome File:</label><input type="text" id="save_filename" value="<?php echo $editor->getDefaultSaveFile();?>"/>
			<select name="format" id="save_format" style="margin-left: 10px; vertical-align: middle;" onchange="updateFormat(this)">
            <option value="" selected>Formato Immagine</option>
            <option value="">---------------------</option>
            <option value="jpeg,85">JPEG HQ</option>
            <option value="jpeg,60">JPEG Media</option>
            <option value="jpeg,35">JPEG Bassa</option>
